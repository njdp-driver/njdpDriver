...
/**
 * Created by SC on 2016/6/20.
 */
public class ListViewAdapter_select_site extends BaseAdapter{
    private Context mContext;
    private String[] mSites;
    private Map<String,Object> mListItems;


    public ListViewAdapter_select_site(Context context,String[] sites,Map<String, Object> listItems)
    {
        mContext=context;
        mSites=sites;
